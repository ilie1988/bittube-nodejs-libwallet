...
extern void mlog_configure(const std::string &filename_base, bool console, const std::size_t max_log_file_size = 104850000, const std::size_t max_log_files = 104850000);
